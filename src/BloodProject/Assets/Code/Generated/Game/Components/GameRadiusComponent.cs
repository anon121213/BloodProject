...
public partial class GameEntity {
    ...
    public _Scripts.Common.Radius radius { get { return (_Scripts.Common.Radius)GetComponent(GameComponentsLookup.Radius); } }
    ...
    public GameEntity AddRadius(float newValue) {
        ...
        var component = (_Scripts.Common.Radius)CreateComponent(index, typeof(_Scripts.Common.Radius));
