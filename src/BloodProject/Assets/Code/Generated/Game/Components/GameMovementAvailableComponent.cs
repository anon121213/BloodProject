...
public partial class GameEntity {
    ...
    static readonly _Scripts.Gameplay.Features.Movement.MovementAvailable movementAvailableComponent = new _Scripts.Gameplay.Features.Movement.MovementAvailable();
