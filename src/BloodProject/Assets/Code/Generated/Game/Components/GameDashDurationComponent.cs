...
public partial class GameEntity {
    ...
    public _Scripts.Gameplay.Features.Dash.DashDuration dashDuration { get { return (_Scripts.Gameplay.Features.Dash.DashDuration)GetComponent(GameComponentsLookup.DashDuration); } }
    ...
    public GameEntity AddDashDuration(float newValue) {
        ...
        var component = (_Scripts.Gameplay.Features.Dash.DashDuration)CreateComponent(index, typeof(_Scripts.Gameplay.Features.Dash.DashDuration));
