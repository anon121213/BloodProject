...
public partial class GameEntity {
    ...
    public _Scripts.Common.ViewPrefab viewPrefab { get { return (_Scripts.Common.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    public _Scripts.Infrastructure.View.EntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(_Scripts.Infrastructure.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (_Scripts.Common.ViewPrefab)CreateComponent(index, typeof(_Scripts.Common.ViewPrefab));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewPrefab(_Scripts.Infrastructure.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (_Scripts.Common.ViewPrefab)CreateComponent(index, typeof(_Scripts.Common.ViewPrefab));
        component.Value = newValue;
