...
public partial class GameEntity {
    ...
    public Gameplay.Features.TargetsCollector.LayerMask layerMask { get { return (Gameplay.Features.TargetsCollector.LayerMask)GetComponent(GameComponentsLookup.LayerMask); } }
    ...
    public GameEntity AddLayerMask(int newValue) {
        ...
        var component = (Gameplay.Features.TargetsCollector.LayerMask)CreateComponent(index, typeof(Gameplay.Features.TargetsCollector.LayerMask));
