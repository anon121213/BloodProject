...
public partial class GameEntity {
    ...
    static readonly _Scripts.Gameplay.Features.Movement.TurnedAlongDirection turnedAlongDirectionComponent = new _Scripts.Gameplay.Features.Movement.TurnedAlongDirection();
