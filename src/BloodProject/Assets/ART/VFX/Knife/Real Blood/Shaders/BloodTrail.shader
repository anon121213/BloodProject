	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 temp_output_72_0 = ( tex2D( _Albedo, uv_Albedo ) * packedInput.ase_color );
				float4 result_albedo93 = temp_output_72_0;
				...
				float switchResult89 = (((isFrontFace>0)?(tex2DNode70.b):(-tex2DNode70.b)));
				float3 appendResult90 = (float3(tex2DNode70.r , tex2DNode70.g , switchResult89));
				float3 result_normal94 = appendResult90;
				
				float4 result_specular97 = _Specular;
				
				float result_smoothness96 = _Smoothness;
				
				float temp_output_80_0 = (temp_output_72_0).a;
				float result_opacity95 = temp_output_80_0;
				
				surfaceDescription.BaseColor = result_albedo93.rgb;
				surfaceDescription.Normal = result_normal94;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = result_specular97.rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = result_smoothness96;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = result_opacity95;
...
WireConnection;98;7;96;0
WireConnection;98;9;95;0
ASEEND*/
//CHKSM=CB7E35BAC88FFE11737451D9C636DC5ED64C13A1