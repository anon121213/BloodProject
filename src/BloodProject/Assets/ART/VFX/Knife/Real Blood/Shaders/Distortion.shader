	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord19 = packedInput.ase_texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				...
				// Flipbook UV
				half2 fbuv46 = texCoord19 * fbtiling46 + fboffset46;
				...
				float3 worldRefl59 = reflect( -V, float3( dot( tanToWorld0, tex2DNode3 ), dot( tanToWorld1, tex2DNode3 ), dot( tanToWorld2, tex2DNode3 ) ) );
				...
				float4 temp_output_68_0 = ( ( temp_output_7_0 * staticSwitch53 ) + ( staticSwitch53 * _Specular * texCUBE( _ReflectionMap, normalizeResult64 ) ) );
				
				surfaceDescription.Color = temp_output_68_0.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( temp_output_68_0.a );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord19 = packedInput.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				int _Frame_Instance = UNITY_ACCESS_INSTANCED_PROP(KnifeDistortion,_Frame);
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles46 = (float)_Columns * (float)_Rows;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				o.ase_texcoord.xyz = inputMesh.ase_texcoord.xyz;
					...
					)
			{
				...
				BuiltinData builtinData;
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord19 = packedInput.ase_texcoord.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				int _Frame_Instance = UNITY_ACCESS_INSTANCED_PROP(KnifeDistortion,_Frame);
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles46 = (float)_Columns * (float)_Rows;
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.IntNode;49;-3558.161,222.7962;Float;False;Property;_Rows;Rows;8;0;Create;True;0;0;0;False;0;False;1;4;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;48;-3555.161,109.7962;Float;False;Property;_Columns;Columns;7;0;Create;True;0;0;0;False;0;False;1;4;False;0;1;INT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-3574.229,-36.49412;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;47;-3546.161,375.7962;Float;False;InstancedProperty;_Frame;Frame;6;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.TFHCFlipBookUVAnimation;46;-3152.004,2.727998;Inherit;False;0;0;6;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;2;-2119.624,-812.2261;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;5e511c12facd3474ebbd24d2b202ffa3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;4;-2066.624,-1021.226;Float;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;5;-1371.311,752.9272;Float;False;Property;_NormalScale;NormalScale;3;0;Create;True;0;0;0;False;0;False;1;-1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3;-1042.311,638.9273;Inherit;True;Property;_NormalMap;NormalMap;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;3bec9ecfa3d3f254981fbc5038211f52;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-1871.541,-343.353;Float;False;Property;_Alpha;Alpha;5;0;Create;True;0;0;0;False;0;False;1;0.963;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-1829.624,-867.2261;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;56;-1602.881,-317.3805;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldReflectionVector;59;-764.1644,401.8087;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ComponentMaskNode;8;-1627.554,-687.3397;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;60;-546.1644,414.8088;Inherit;False;True;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-617.1644,553.8087;Float;False;Property;_SpecularNormalMul;SpecularNormalMul;11;0;Create;True;0;0;0;False;0;False;0;4.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;54;-1377.881,-419.3805;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-1475.454,32.6517;Float;False;Property;_AlphaPower;AlphaPower;14;0;Create;True;0;0;0;False;0;False;0;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;55;-1284.11,-130.3975;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;-283.1644,411.8088;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PowerNode;70;-1102.454,-49.3483;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-1340.843,-584.9871;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;63;-148.1644,456.8087;Inherit;False;FLOAT3;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalizeNode;64;-18.71783,457.4708;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=2E3DB94CB3ECBAC017EAD3D9A9A40DC454BD2139