	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_DisplacementNoise = inputMesh.ase_texcoord * _DisplacementNoise_ST.xy + _DisplacementNoise_ST.zw;
				float4 texCoord23 = inputMesh.ase_texcoord;
				texCoord23.xy = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float Scale69 = ( texCoord23.w + _Scale );
				float2 texCoord75 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _PARTICLESCALEAFFECT_ON
				float staticSwitch76 = texCoord75.x;
				#else
				float staticSwitch76 = 1.0;
				#endif
				float3 result_vertex_offset83 = ( ( ( _MaxDisplacement * tex2Dlod( _DisplacementNoise, float4( uv_DisplacementNoise, 0, 0.0) ).r ) + _MaxScale ) * inputMesh.normalOS * Scale69 * staticSwitch76 );
				...
				#endif
				float3 vertexValue = result_vertex_offset83;
						...
						)
			{
				...
				float switchResult70 = (((isFrontFace>0)?(tex2DNode2.b):(-tex2DNode2.b)));
				...
				float3 worldRefl16 = reflect( -V, float3( dot( tanToWorld0, appendResult71 ), dot( tanToWorld1, appendResult71 ), dot( tanToWorld2, appendResult71 ) ) );
				...
				float4 result_albedo78 = ( ( packedInput.ase_color * _Tint ) + ( _Specular * texCUBE( _ReflectionMap, normalizeResult42 ) ) );
				
				float3 result_normal80 = appendResult71;
				
				float4 result_specular79 = _SpecularColor;
				
				float result_smoothness81 = _Smothness;
				
				float4 screenPos = packedInput.ase_texcoord7;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth53 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float4 texCoord23 = packedInput.ase_texcoord5;
				texCoord23.xy = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_24_0 = ( _Errosion + texCoord23.z );
				float FinalAlpha54 = ( clampResult51 * ( packedInput.ase_color.a * saturate( ( ( tex2D( _MainTex, uv_MainTex ).r - temp_output_24_0 ) / _Softness ) ) ) );
				float result_opacity82 = FinalAlpha54;
				
				surfaceDescription.BaseColor = result_albedo78.rgb;
				surfaceDescription.Normal = result_normal80;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = result_specular79.rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = result_smoothness81;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = result_opacity82;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 uv_DisplacementNoise = inputMesh.uv0.xy * _DisplacementNoise_ST.xy + _DisplacementNoise_ST.zw;
				float4 texCoord23 = inputMesh.uv0;
				texCoord23.xy = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float Scale69 = ( texCoord23.w + _Scale );
				float2 texCoord75 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _PARTICLESCALEAFFECT_ON
				float staticSwitch76 = texCoord75.x;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 worldRefl16 = reflect( -ase_worldViewDir, float3( dot( tanToWorld0, appendResult71 ), dot( tanToWorld1, appendResult71 ), dot( tanToWorld2, appendResult71 ) ) );
				float3 appendResult46 = (float3(( (worldRefl16).xy * _SpecularNormalMul ) , worldRefl16.z));
				float3 normalizeResult42 = normalize( appendResult46 );
				float4 result_albedo78 = ( ( packedInput.ase_color * _Tint ) + ( _Specular * texCUBE( _ReflectionMap, normalizeResult42 ) ) );
				...
				float distanceDepth53 = abs( ( screenDepth53 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _FadeDistance ) );
				float clampResult51 = clamp( distanceDepth53 , 0.0 , 1.0 );
				float4 texCoord23 = packedInput.ase_texcoord2;
				texCoord23.xy = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_24_0 = ( _Errosion + texCoord23.z );
				float FinalAlpha54 = ( clampResult51 * ( packedInput.ase_color.a * saturate( ( ( tex2D( _MainTex, uv_MainTex ).r - temp_output_24_0 ) / _Softness ) ) ) );
				float result_opacity82 = FinalAlpha54;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				texCoord23.xy = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float Scale69 = ( texCoord23.w + _Scale );
				float2 texCoord75 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _PARTICLESCALEAFFECT_ON
				float staticSwitch76 = texCoord75.x;
				#else
				float staticSwitch76 = 1.0;
		...
		Pass
		{
					...
					)
			{
				...
				float distanceDepth53 = abs( ( screenDepth53 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _FadeDistance ) );
				float clampResult51 = clamp( distanceDepth53 , 0.0 , 1.0 );
				float4 texCoord23 = packedInput.ase_texcoord3;
				texCoord23.xy = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_24_0 = ( _Errosion + texCoord23.z );
				float FinalAlpha54 = ( clampResult51 * ( packedInput.ase_color.a * saturate( ( ( tex2D( _MainTex, uv_MainTex ).r - temp_output_24_0 ) / _Softness ) ) ) );
				float result_opacity82 = FinalAlpha54;
		...
		Pass
		{
						...
						)
			{
				...
				float distanceDepth53 = abs( ( screenDepth53 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _FadeDistance ) );
				float clampResult51 = clamp( distanceDepth53 , 0.0 , 1.0 );
				float4 texCoord23 = packedInput.ase_texcoord7;
				texCoord23.xy = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_24_0 = ( _Errosion + texCoord23.z );
				float FinalAlpha54 = ( clampResult51 * ( packedInput.ase_color.a * saturate( ( ( tex2D( _MainTex, uv_MainTex ).r - temp_output_24_0 ) / _Softness ) ) ) );
				float result_opacity82 = FinalAlpha54;
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1357.071,929.3242;Float;False;Property;_NormalScale;NormalScale;7;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2;-1207.246,499.47;Inherit;True;Property;_Normal;Normal;1;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;-1;None;7abbec8462512bd46871c78fc9abec2a;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-2084.694,329.7405;Float;False;Property;_Errosion;Errosion;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldReflectionVector;16;-388.9095,742.3661;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;1;-1048.283,-120.5145;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;fe2d475c68dd30b438af1a032133b71e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-287.364,944.7702;Float;False;Property;_SpecularNormalMul;SpecularNormalMul;14;0;Create;True;0;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-778.9198,205.4213;Float;False;Property;_Softness;Softness;4;0;Create;True;0;0;0;False;0;False;1;0.15;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;258.8332,-162.5158;Float;False;Property;_FadeDistance;FadeDistance;8;0;Create;True;0;0;0;False;0;False;0.02;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-2201.511,809.5727;Float;False;Property;_Scale;Scale;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;53;505.8331,-230.5158;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;911.2635,693.3096;Float;False;Property;_MaxDisplacement;MaxDisplacement;16;0;Create;True;0;0;0;False;0;False;0.1;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;58;808.5776,796.4774;Inherit;True;Property;_DisplacementNoise;DisplacementNoise;15;0;Create;True;0;0;0;False;0;False;-1;None;97318301147cec541bd42658de1bbd7f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;20;-1026.793,-490.8484;Float;False;Property;_Tint;Tint;11;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;63;1031.264,1032.309;Float;False;Property;_MaxScale;MaxScale;17;0;Create;True;0;0;0;False;0;False;1;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;51;676.8332,-150.5158;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;69;-1641.512,762.5727;Float;False;Scale;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;496.2905,657.666;Inherit;True;Property;_ReflectionMap;ReflectionMap;9;0;Create;True;0;0;0;False;0;False;-1;None;c6ba66ab77fde32449695eaf84e29471;True;0;False;black;LockedToCube;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-48.30959,602.6661;Float;False;Property;_Specular;Specular;10;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;76;1262.531,1398.74;Float;False;Property;_ParticleScaleAffect;ParticleScaleAffect;13;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-442.2833,-25.51455;Float;False;Property;_Smothness;Smothness;6;0;Create;True;0;0;0;False;0;False;0.9529412;0.852;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;74;1180.702,-203.6042;Float;False;Property;_SpecularColor;SpecularColor;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4528301,0.4528301,0.4528301,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;81;0;12;0
WireConnection;84;0;78;0
WireConnection;84;1;80;0
WireConnection;84;5;79;0
WireConnection;84;7;81;0
WireConnection;84;9;82;0
WireConnection;84;11;83;0
ASEEND*/
//CHKSM=ADAB8A69DE477A7674AB223C3EA96914A85B659B