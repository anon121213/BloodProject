	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 albedo13 = ( lerpResult9 * tex2D( _Albedo, uv_Albedo ) );
				...
				float4 specular15 = tex2DNode6;
				
				float spec_smoothness16 = ( tex2DNode6.a * _Smoothness );
				
				surfaceDescription.BaseColor = albedo13.rgb;
				surfaceDescription.Normal = normals14;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = specular15.rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = spec_smoothness16;
...
ASEEND*/
//CHKSM=7232E7048D5FE092EA8857CDD487E40F3AA7E3B7