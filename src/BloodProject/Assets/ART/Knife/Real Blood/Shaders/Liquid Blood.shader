	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 temp_output_10_0 = ( packedInput.ase_color * lerpResult55 );
				...
				float3 worldRefl16 = reflect( -V, float3( dot( tanToWorld0, tex2DNode2 ), dot( tanToWorld1, tex2DNode2 ), dot( tanToWorld2, tex2DNode2 ) ) );
				...
				float4 result_albedo69 = ( temp_output_10_0 + ( _Specular * texCUBE( _ReflectionMap, normalizeResult42 ) ) );
				
				float3 result_normal71 = tex2DNode2;
				
				float result_metallic70 = _Metallic;
				
				float result_smoothness72 = _Smothness;
				...
				float FinalAlpha54 = ( clampResult51 * ( packedInput.ase_color.a * clampResult60 ) * (temp_output_10_0).a * _Alpha );
				float result_opacity73 = FinalAlpha54;
				
				surfaceDescription.BaseColor = result_albedo69.rgb;
				surfaceDescription.Normal = result_normal71;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = result_metallic70;
				...
				surfaceDescription.Smoothness = result_smoothness72;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = saturate( result_opacity73 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 worldRefl16 = reflect( -ase_worldViewDir, float3( dot( tanToWorld0, tex2DNode2 ), dot( tanToWorld1, tex2DNode2 ), dot( tanToWorld2, tex2DNode2 ) ) );
				float3 appendResult46 = (float3(( (worldRefl16).xy * _SpecularNormalMul ) , worldRefl16.z));
				float3 normalizeResult42 = normalize( appendResult46 );
				float4 result_albedo69 = ( temp_output_10_0 + ( _Specular * texCUBE( _ReflectionMap, normalizeResult42 ) ) );
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.TextureCoordinatesNode;38;-1699.24,296.1099;Inherit;False;0;1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-986.1643,839.7092;Float;False;Property;_NormalScale;NormalScale;4;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;-1555.158,99.18211;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;b9fff8b175bb5cf45852bdad56af77b9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;63;-1341.611,345.0229;Float;False;Property;_AlphaRemapColorBlend;AlphaRemapColorBlend;10;0;Create;True;0;0;0;False;0;False;0,1,0,1;0,0.8,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-704.9028,708.5743;Inherit;True;Property;_Normal;Normal;1;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;-1;None;4788bad6d7d1dd34692f230d4646565d;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;61;-1111.03,203.7357;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-287.364,944.7702;Float;False;Property;_SpecularNormalMul;SpecularNormalMul;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;59;-962.5824,402.6683;Float;False;Property;_AlphaRemap;AlphaRemap;11;0;Create;True;0;0;0;False;0;False;0,1,0,1;0,0.55,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;20;-871.3125,-607.9806;Float;False;Property;_Tint;Tint;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;62;-930.1828,235.384;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;56;-934.3248,-307.1588;Float;False;Property;_Tint2;Tint 2;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.49,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;55;-556.8054,-358.0222;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;9;-856.4006,-24.19998;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;48;298.05,-64.4738;Float;False;Property;_FadeDistance;FadeDistance;12;0;Create;True;0;0;0;False;0;False;0.02;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;58;-732.0016,261.3811;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-397.2849,-59.69388;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;60;-551.1543,293.0294;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;67;-210.0119,-148.5778;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;37.80782,73.99613;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;42;366.636,868.7702;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;68;510.1882,206.3222;Float;False;Property;_Alpha;Alpha;13;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;905.05,48.52625;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-48.30959,602.6661;Float;False;Property;_Specular;Specular;6;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;496.2905,657.666;Inherit;True;Property;_ReflectionMap;ReflectionMap;5;0;Create;True;0;0;0;False;0;False;-1;None;c6ba66ab77fde32449695eaf84e29471;True;0;False;black;LockedToCube;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;73;1253.087,91.85303;Inherit;False;result_opacity;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;74;7;72;0
WireConnection;74;9;85;0
WireConnection;74;10;88;0
WireConnection;72;0;12;0
WireConnection;70;0;11;0
WireConnection;71;0;2;0
ASEEND*/
//CHKSM=3E50D367DFD38D559B55DC439A394125E77E6B87